...
public class MovieController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(code = 404, message = "Mensaje de pelicula no encontrada", response = ErrorDto.class)
    })
    @GetMapping("/{uuid}")
    ...
    @ApiResponses({
            ...
            @ApiResponse(code = 400, message = "La pelicula ya existe", response = ErrorDto.class)
    })
    @PostMapping
    ...
    @ApiResponses({
            ...
            @ApiResponse(code = 404, message = "La pelicula ya no existe", response = ErrorDto.class)
    })
    @PatchMapping
    ...
    @ApiResponses({
            ...
            @ApiResponse(code = 400, message = "La pelicula ya no existe", response = ErrorDto.class)
    })
    @DeleteMapping("/{uuid}")
